  ...
  return (
    <div
      ...
      <div className="front focus:outline-none focus:ring-0" ref={frontEl}>
        <span className="jp-font text-2xl font-semibold text-gray-700">
          {flashcard.front}
        </span>
      </div>
      <div
        className="back font-semibold text-gray-700 text-center focus:outline-none focus:ring-0"
        ref={backEl}>
        <span className="jp-font block">{flashcard.romaji}</span>
